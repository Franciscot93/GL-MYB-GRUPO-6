...
function Pet({pet}) {
  ...
  return (
    ...
    <div className="block m-2 lg:max-w-[18rem] lg:max-h-[18rem] mt-3 rounded-lg bg-transparent shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] box-content">
    ...
    <div className=" text-left flex flex-row flex-wrap shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] rounded-md">
