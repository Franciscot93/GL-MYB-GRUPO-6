    ...
    <section className="border-opacity-25">
      <div className=" w-full  flex bg-gradient-to-r from-[#48b0ff] to-[#0d3c9b] flex-wrap  flex-row justify-between">
        ...
        <div className=" flex flex-wrap  m-auto items-center text-base justify-center">
          ...
          <Link to={"/about"} className="mr-5 text-white hover:text-[#83cdff]">Nosotros</Link>
        </div>
        <div className="justify-center flex m-auto flex-wrap items-center content-center">
        <Link to={"/usuario/login"} className="mr-5">
            <button value="MiCuenta" onClick={cambiarValor} className={(!window.localStorage.getItem('email'))?"inline-flex font-bold  rounded items-center  bg-yellow-500 border-0 py-1 px-3 mt-4":"inline-flex rounded items-center  bg-red-600 hover:bg-red-500 text-slate-50 font-bold  border-0 py-1 px-3 mt-4"}>
