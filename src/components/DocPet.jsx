function DocPet({ archivoPet }) {
  return (
    <div className="w-full px-2 m-2 ">
      <div
        className="flex flex-col  justify-center content-center place-items-center"
        key={archivoPet.id}
      >
        <p className="font-semibold text-slate-900 relative text-xl text-center p-1 w-full">
          Fecha: {archivoPet.fecha}
        </p>
        <iframe
