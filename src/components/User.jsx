  ...
  return (
   // Contenedor principal de la informacion del usuario
    <section className="w-full">
      ...
      <div className="mx-3 relative w-100 h-1/2 text-center flex justify-center aspect-square  text-[#066aff]
         shadow-md mt-3 rounded-md  "><Image className="aspect-square" cloudName="dqr2aiayz"publicId={user?.Imagen}/></div>
