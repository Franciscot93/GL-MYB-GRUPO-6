    ...
    <main>
      ...
      <section className="shadow-md flex flex-wrap my-2 mx-3  py-5">
        ...
        <aside className="md:w-3/5 lg:4/5 mt-5 w-full text-center md:h-screen overflow-y-scroll overflow-x-hidden">
          <h2 className="text-4xl text-center logoTitle text-[#066aff]  border-b-2 border-indigo-700 py-1 mx-3">
            Tus Mascotas{" "}
          </h2>
          <div className=" flex w-full relative p-1">
            {user?.mascotas.length > 0 ? (
              ...
              <h3 className="text-3xl w-full animate-pulse text-center text-slate-800 logoTitle">
                NO HAY MASCOTAS
              </h3>
            )}
          </div>
      ...
      <div className="shadow-md my-2 mx-3 py-5 box-border ">
        <Link
          ...
          className="logoTitle py-4 px-2 w-full text-3xl bg-[#0841c5] hover:bg-[#066aff]  hover:cursor-pointer  text-[#fff] rounded-md"
        >
          Agregar MaScOtA
        </Link>
      </div>
