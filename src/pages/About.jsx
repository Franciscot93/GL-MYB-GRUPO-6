...
const About = () => {
  return (
    <main className="w-full flex">
      <div
        className="aspect-square w-1/2 rounded-md flex flex-col transition-transform duration-300 hover:transform hover:scale-105 items-center justify-center bg-cover bg-center"
        style={{
